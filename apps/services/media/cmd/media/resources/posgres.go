...
import (
	...
	gnexalogger "media-service/infrastructure/logger"
...
func InitDB(cfg *config.AppConfig) *gorm.DB {
	...
	// Pasang adapter kita ke dalam config GORM
	...
	if err != nil {
		...
		gnexalogger.Error(ctx, "infra:database", "Failed to connect to Database", err, nil)
		panic(err)
	}
