...
func (f *CustomFormatter) Format(entry *logrus.Entry) ([]byte, error) {
	...
	// 🚀 UBAH DI SINI: Ganti product-service menjadi media-service
	fmt.Fprintf(b, "%s %s %s %s ", timestamp, levelStr, magenta("[media-service]"), cyan(fmt.Sprintf("[%s]", strings.ToUpper(layer))))
