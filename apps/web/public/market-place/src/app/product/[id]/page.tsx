                ...
                <div className="aspect-square bg-muted rounded-xl overflow-hidden border">
                    {product.images?.[0] ? (
                        ...
                        <div className="flex items-center justify-center h-full text-muted-foreground bg-muted/50">
                            <span className="text-6xl font-bold opacity-10">GNEXA</span>
                        </div>
                    )}
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-4 bg-muted/30 rounded-lg border space-y-2">
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium text-green-600">In Stock ({product.stock} units)</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-muted-foreground">Category:</span>
                            <span className="font-medium capitalize">{product.categoryId || 'General'}</span>
                        </div>
                    </div>
