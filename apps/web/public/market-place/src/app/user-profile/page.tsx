...
import { useUser, useUpdateProfile } from '@/application/hooks/useAuth';
import { useUploadMedia } from '@/application/hooks/useMedia';
        ...
        if (file) {
            uploadMedia(file, {
                onSuccess: (response: any) => {
                    ...
                    updateProfile({ profilePicture: response.data.FileURL }, {
                        onSuccess: () => {
            ...
            <Card>
                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        <div className="relative h-32 w-32 rounded-full overflow-hidden bg-muted border-2 border-primary/20 group cursor-pointer"
