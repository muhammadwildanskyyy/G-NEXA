...
* **Golang (Gin Gonic & Go Fiber):** Pilar utama untuk **Product Service**, **Finance Service**, dan **Media Service**. Golang dipilih karena efisiensi memori, kecepatan eksekusi yang tinggi, dan performa *concurrency* (Goroutines) yang luar biasa. Khusus untuk **Product Service**—yang merupakan layanan paling sibuk dalam ekosistem G-NEXA—Golang menjamin waktu respons sub-milidetik untuk pembacaan katalog skala besar serta penanganan *throughput* tinggi saat mengonsumsi event Kafka. Kombinasi *framework* Gin Gonic yang minimalis dan **Go Fiber** memastikan layanan-layanan ini mampu memproses tugas dengan latensi ultra-rendah dan kecepatan maksimum.
* **Express.js:** Digunakan sebagai fondasi untuk **User Service** (termasuk manajemen toko). Sifatnya yang *un-opinionated*, ringan, dan gesit menjadikannya pilihan sempurna untuk melayani *traffic* autentikasi dan rute API yang membutuhkan respon instan tanpa *overhead* kerangka kerja yang berat.
